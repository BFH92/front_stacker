...
const SendEmail = () => {
  return (
    <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
        ...
        <g id="Iconly/Light/Send" stroke="none" strokeWidth="1" fill="none" fill-rule="evenodd" strokeLinecap="round" strokeLinejoin="round">
            <g id="Send" transform="translate(3.000000, 3.000000)" stroke="rgb(92, 30, 226)" strokeWidth="1.5">
