...
const Notifications = () => {
  ...
  return(
    <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
        ...
        <g id="Light/Notifications" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" stroke-linecap="round" stroke-linejoin="round">
            <g id="header--Notifications" transform="translate(3.500000, 2.000000)" stroke="#000000" stroke-width="1.5">
