...
const DarkStrokeSignUp = () => {
  return (
    <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
        <title>Iconly/Light/Add User</title>
        <g id="Iconly/Light/Add-User" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd" strokeLinecap="round" strokeLinejoin="round">
            <g id="Add-User" transform="translate(2.000000, 2.000000)" stroke="#000000" strokeWidth="1.5">
...
export default DarkStrokeSignUp;
