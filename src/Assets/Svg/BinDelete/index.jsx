...
const BinDelete = () => {
  return (
    <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
        ...
        <g id="Iconly/Light/Delete" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd" strokeLinecap="round" strokeLinejoin="round">
            <g id="Delete" transform="translate(3.000000, 2.000000)" stroke="#d32f2f" strokeWidth="1.5">
