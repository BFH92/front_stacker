...
const DarkStrokeDashboard = () => {
  return (
    <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
        <title>Iconly/Light/Activity</title>
        <g id="Iconly/Light/Activity" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd" strokeLinecap="round" strokeLinejoin="round">
            <g id="svg__stroke--dashboard" transform="translate(2.000000, 1.500000)" stroke="#000000" strokeWidth="1.5">
...
export default DarkStrokeDashboard;
