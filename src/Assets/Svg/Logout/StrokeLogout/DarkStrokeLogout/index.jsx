...
const StrokeLogout = () => {
  return (
    <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
        ...
        <g id="Iconly/Light/Logout" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd" strokeLinecap="round" strokeLinejoin="round">
            <g id="svg__stroke--logout" transform="translate(2.000000, 2.000000)" stroke="rgb(235, 41, 86)" strokeWidth="1.5">
